/**
 * Generated by tsnapi — public API snapshot of `@setemiojo/eslint-config`
 */
// #region Interfaces
...
export interface RuleOptions {
  ...
  'angular-template/prefer-style-binding'?: Linter.RuleEntry<[]>;
  ...
  'angular/inject-at-top'?: Linter.RuleEntry<AngularInjectAtTop>;
  ...
  'angular/prefer-signal-model'?: Linter.RuleEntry<AngularPreferSignalModel>;
  'angular/prefer-signals'?: Linter.RuleEntry<AngularPreferSignals>;
  'angular/prefer-standalone'?: Linter.RuleEntry<[]>;
  'angular/reactive-context-must-read-signal'?: Linter.RuleEntry<AngularReactiveContextMustReadSignal>;
  ...
  'setemiojo/consistent-chaining'?: Linter.RuleEntry<SetemiojoConsistentChaining>;
  'setemiojo/consistent-list-newline'?: Linter.RuleEntry<SetemiojoConsistentListNewline>;
  'setemiojo/curly'?: Linter.RuleEntry<[]>;
  'setemiojo/if-newline'?: Linter.RuleEntry<[]>;
  'setemiojo/import-dedupe'?: Linter.RuleEntry<[]>;
  'setemiojo/indent-unindent'?: Linter.RuleEntry<SetemiojoIndentUnindent>;
  'setemiojo/no-import-dist'?: Linter.RuleEntry<[]>;
  'setemiojo/no-import-node-modules-by-path'?: Linter.RuleEntry<[]>;
  'setemiojo/no-top-level-await'?: Linter.RuleEntry<[]>;
  'setemiojo/no-ts-export-equal'?: Linter.RuleEntry<[]>;
  'setemiojo/top-level-function'?: Linter.RuleEntry<[]>;
  ...
  'slop/no-static-only-class'?: Linter.RuleEntry<SlopNoStaticOnlyClass>;
...
export type ConfigNames = 'setemiojo/gitignore' | 'setemiojo/ignores' | 'setemiojo/javascript/setup' | 'setemiojo/javascript/rules' | 'setemiojo/eslint-comments/rules' | 'setemiojo/command/rules' | 'setemiojo/perfectionist/setup' | 'setemiojo/node/setup' | 'setemiojo/node/rules' | 'setemiojo/jsdoc/setup' | 'setemiojo/jsdoc/rules' | 'setemiojo/imports/rules' | 'setemiojo/e18e/rules' | 'setemiojo/unicorn/setup' | 'setemiojo/unicorn/rules' | 'setemiojo/jsx/setup' | 'setemiojo/typescript/setup' | 'setemiojo/typescript/parser' | 'setemiojo/typescript/type-aware-parser' | 'setemiojo/typescript/rules' | 'setemiojo/typescript/rules-type-aware' | 'setemiojo/typescript/erasable-syntax-only' | 'setemiojo/antislop/setup' | 'setemiojo/antislop/rules/universal' | 'setemiojo/antislop/rules/javascript' | 'setemiojo/stylistic/rules' | 'setemiojo/regexp/rules' | 'setemiojo/test/setup' | 'setemiojo/test/rules' | 'setemiojo/vue/setup' | 'setemiojo/vue/rules' | 'setemiojo/react/setup' | 'setemiojo/react/rules' | 'setemiojo/react/typescript' | 'setemiojo/react/type-aware-rules' | 'setemiojo/tanstack-router/setup' | 'setemiojo/tanstack-router/rules' | 'setemiojo/tanstack-router/type-aware-rules' | 'setemiojo/nextjs/setup' | 'setemiojo/nextjs/rules' | 'setemiojo/solid/setup' | 'setemiojo/solid/rules' | 'setemiojo/svelte/setup' | 'setemiojo/svelte/rules' | 'setemiojo/unocss' | 'setemiojo/astro/setup' | 'setemiojo/astro/rules' | 'setemiojo/angular/setup' | 'setemiojo/angular/rules/ts' | 'setemiojo/angular/rules/template' | 'setemiojo/jsonc/setup' | 'setemiojo/jsonc/rules' | 'setemiojo/sort/package-json' | 'setemiojo/sort/tsconfig-json' | 'setemiojo/pnpm/package-json' | 'setemiojo/pnpm/pnpm-workspace-yaml' | 'setemiojo/pnpm/pnpm-workspace-yaml-stylistic' | 'setemiojo/pnpm/pnpm-workspace-yaml-sort' | 'setemiojo/yaml/setup' | 'setemiojo/yaml/rules' | 'setemiojo/toml/setup' | 'setemiojo/toml/rules' | 'setemiojo/markdown/setup' | 'setemiojo/markdown/processor' | 'setemiojo/markdown/parser' | 'setemiojo/markdown/rules' | 'setemiojo/markdown/disables/code' | 'setemiojo/formatter/setup' | 'setemiojo/formatter/css' | 'setemiojo/formatter/scss' | 'setemiojo/formatter/less' | 'setemiojo/formatter/html' | 'setemiojo/formatter/xml' | 'setemiojo/formatter/svg' | 'setemiojo/formatter/markdown' | 'setemiojo/formatter/astro' | 'setemiojo/formatter/astro/disables' | 'setemiojo/formatter/graphql' | 'setemiojo/disables/scripts' | 'setemiojo/disables/cli' | 'setemiojo/disables/bin' | 'setemiojo/disables/dts' | 'setemiojo/disables/cjs' | 'setemiojo/disables/config-files';
...
export declare function setemiojo(_?: OptionsConfig & Omit<TypedFlatConfigItem, 'files' | 'ignores'>, ..._: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[] | FlatConfigComposer<any, any> | Linter.Config[]>[]): FlatConfigComposer<TypedFlatConfigItem, ConfigNames>;
...
export declare function tanstackRouter(_?: OptionsTypeScriptParserOptions & OptionsTypeScriptWithTypes & OptionsOverrides & OptionsFiles): Promise<TypedFlatConfigItem[]>;
...
type AngularReactiveContextMustReadSignal = [] | [{
...
type SetemiojoConsistentChaining = [] | [{
  allowLeadingPropertyAccess?: boolean;
}];
type SetemiojoConsistentListNewline = [] | [{

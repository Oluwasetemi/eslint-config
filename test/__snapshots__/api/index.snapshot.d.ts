...
export type ConfigNames = 'setemiojo/gitignore' | 'setemiojo/ignores' | 'setemiojo/javascript/setup' | 'setemiojo/javascript/rules' | 'setemiojo/eslint-comments/rules' | 'setemiojo/command/rules' | 'setemiojo/perfectionist/setup' | 'setemiojo/node/setup' | 'setemiojo/node/rules' | 'setemiojo/jsdoc/setup' | 'setemiojo/jsdoc/rules' | 'setemiojo/imports/rules' | 'setemiojo/e18e/rules' | 'setemiojo/unicorn/rules' | 'setemiojo/jsx/setup' | 'setemiojo/typescript/setup' | 'setemiojo/typescript/parser' | 'setemiojo/typescript/type-aware-parser' | 'setemiojo/typescript/rules' | 'setemiojo/typescript/rules-type-aware' | 'setemiojo/typescript/erasable-syntax-only' | 'setemiojo/stylistic/rules' | 'setemiojo/regexp/rules' | 'setemiojo/test/setup' | 'setemiojo/test/rules' | 'setemiojo/vue/setup' | 'setemiojo/vue/rules' | 'setemiojo/react/setup' | 'setemiojo/react/rules' | 'setemiojo/react/typescript' | 'setemiojo/react/type-aware-rules' | 'setemiojo/nextjs/setup' | 'setemiojo/nextjs/rules' | 'setemiojo/solid/setup' | 'setemiojo/solid/rules' | 'setemiojo/svelte/setup' | 'setemiojo/svelte/rules' | 'setemiojo/unocss' | 'setemiojo/astro/setup' | 'setemiojo/astro/rules' | 'setemiojo/angular/setup' | 'setemiojo/angular/rules/ts' | 'setemiojo/angular/rules/template' | 'setemiojo/jsonc/setup' | 'setemiojo/jsonc/rules' | 'setemiojo/sort/package-json' | 'setemiojo/sort/tsconfig-json' | 'setemiojo/pnpm/package-json' | 'setemiojo/pnpm/pnpm-workspace-yaml' | 'setemiojo/pnpm/pnpm-workspace-yaml-sort' | 'setemiojo/yaml/setup' | 'setemiojo/yaml/rules' | 'setemiojo/toml/setup' | 'setemiojo/toml/rules' | 'setemiojo/markdown/setup' | 'setemiojo/markdown/processor' | 'setemiojo/markdown/parser' | 'setemiojo/markdown/rules' | 'setemiojo/markdown/disables/markdown' | 'setemiojo/markdown/disables/code' | 'setemiojo/formatter/setup' | 'setemiojo/formatter/css' | 'setemiojo/formatter/scss' | 'setemiojo/formatter/less' | 'setemiojo/formatter/html' | 'setemiojo/formatter/xml' | 'setemiojo/formatter/svg' | 'setemiojo/formatter/markdown' | 'setemiojo/formatter/astro' | 'setemiojo/formatter/astro/disables' | 'setemiojo/formatter/graphql' | 'setemiojo/disables/scripts' | 'setemiojo/disables/cli' | 'setemiojo/disables/bin' | 'setemiojo/disables/dts' | 'setemiojo/disables/cjs' | 'setemiojo/disables/config-files';

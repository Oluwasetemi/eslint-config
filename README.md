...
// Type of the project. 'lib' for libraries, the default is 'app'
  ...
  // Or use a function to modify default ignores
  ignores: defaults => [
    ...defaults,
    '**/my-custom-ignore',
  ]
...
Since v3.16.0, they are no longer disabled, but made non-fixable using [this helper](https://github.com/setemiojo/eslint-flat-config-utils#composerdisablerulesfix).

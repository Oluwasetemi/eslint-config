...
function buildCssConfigs(prettierOptions: VendoredPrettierOptions): TypedFlatConfigItem[] {
  return ([
    [[GLOB_CSS, GLOB_POSTCSS], 'css', 'setemiojo/formatter/css'],
    [[GLOB_SCSS], 'scss', 'setemiojo/formatter/scss'],
    [[GLOB_LESS], 'less', 'setemiojo/formatter/less'],
...
function buildMarkdownConfigs(
  ...
  if (options.slidev) {
    configs.push({
      ...
      name: 'setemiojo/formatter/slidev',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
...
export async function formatters(
  ...
  if (options.xml)
    configs.push(buildXmlLikeConfig(prettierOptions, prettierXmlOptions, [GLOB_XML], 'setemiojo/formatter/xml'))

  if (options.svg)
    configs.push(buildXmlLikeConfig(prettierOptions, prettierXmlOptions, [GLOB_SVG], 'setemiojo/formatter/svg'))

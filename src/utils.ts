...
const isCwdInScope = isPackageExists('@setemiojo/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@setemiojo/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@setemiojo/eslint-config'
